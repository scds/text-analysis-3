...
<img src="../assets/img/tmv/voyant-home.png" alt="Screenshot of Voyant homepage, which is primarily blank except for a rectangle at the center of the page that reads 'Add texts' with a large blue 'Reveal' button and, at the top of a page, a large Voyant Tool logo where the 'O' in Voyant is an adorable cartoon owl." width="100%">
...
<img src="../assets/img/tmv/voyant-password.png" width="75%">
...
<img src="../assets/img/tmv/voyant-upload.png" width="100%">
...
<img src="../assets/img/tmv/voyant-full-dash.png" alt="Voyant dashboard divided into five rectangular areas - three on top and two below - that each contain the visualization for a different tools. In the default arrangement, the tools are (in clockwise order starting from top left): Cirrus, Reader, Trends, Summary and Contexts." width="100%">
...
<img src="../assets/img/tmv/voyant-summary.png" width="100%">
...
<img src="../assets/img/tmv/voyant-reader.png" width="60%">
...
<img src="../assets/img/tmv/voyant-download.png" alt="Screenshot of Documents tool download dialog box, highlighting 'Documents', 'Download' and 'plain text' buttons." width="100%">
...
<img src="../assets/img/tmv/voyant-change-tool.png" width="100%">

<img src="../assets/img/tmv/voyant-tool-list.png" width="60%">
...
<img src="../assets/img/tmv/voyant-topic-interface.png" alt="Screenshot of the Topics tool, showing a colour-coded set of topics with their tokens (e.g. public supporting indigenous fight ensure vaccination gender vaccine rights children; more topics will be listed later in the text). On the right is a visualization showing the distribution of the topics in each document of the corpus. Each topic is present in each document to varying degrees; some topics are well-represented in one document or another." width="100%">
...
<img src="../assets/img/tmv/voyant-options-location.png" width="75%">
...
<img src="../assets/img/tmv/voyant-topic-options.png" alt="Screenshot of the options menu containing fields for stopwords, terms per document, iterations and random seed." width="75%">
...
<img src="../assets/img/tmv/voyant-topic-params.png" alt="Screenshot of topic parameters: a search bar labeled 'search'; a slider button to set the number of terms per topic; a slider button to set the number of topics; a button labeled 'Run'." width="100%">
...
<img src="../assets/img/tmv/voyant-topics-final.png" width="100%">
...
<img src="../assets/img/tmv/voyant-topic-prevalence.png" width="100%">
...
<img src="../assets/img/tmv/voyant-topics-document.png" width="100%">
...
<img src="../assets/img/tmv/voyant-export-button.png" width="100%">
...
<img src="../assets/img/tmv/voyant-export-values.png" width="70%">
